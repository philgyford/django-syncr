...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TwitterUser.last_tweet_synced'
        db.add_column('twitter_twitteruser', 'last_tweet_synced', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TwitterUser.last_tweet_synced'
        db.delete_column('twitter_twitteruser', 'last_tweet_synced')
    ...
    models = {
        ...
        'twitter.twitteruser': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_tweet_synced': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
