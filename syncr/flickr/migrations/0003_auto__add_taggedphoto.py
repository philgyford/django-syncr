...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('flickr_taggedphoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flickr_taggedphoto_items', to=orm['taggit.Tag'])),
            ...
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flickr_taggedphoto_items', to=orm['flickr.Photo'])),
        ))
        db.send_create_signal('flickr', ['TaggedPhoto'])


    def backwards(self, orm):
        
        # Deleting model 'TaggedPhoto'
        db.delete_table('flickr_taggedphoto')
