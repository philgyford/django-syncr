"""
Magnolia as a service no longer exists, so the syncing code no longer works.
This model remains purely for those who have previously-synced historical data.
"""
